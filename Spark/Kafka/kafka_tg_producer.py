...
FILE_PATH = "E:/BigData/Spark/TimeGender.csv"
columns = ['date','time','sex','confiremd','deceased']
...
def main(topic):
    ...
    mynewjson = schema_registry_client.get_schema(schema_id=100013).schema_str
