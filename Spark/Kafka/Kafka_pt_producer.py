...
FILE_PATH = "E:/BigData/Kafka_demo/PatientInfo.csv"
columns = ['patient_id','sex','age','country','province','city','infection_case','infected_by'
...
def main(topic):
    ...
    mynewjson = schema_registry_client.get_schema(schema_id=100003).schema_str
